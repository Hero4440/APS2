!(function (t, e) {
  ...
  function F(t, e, i) {
    ...
    return (
      ...
      ot.fx.timer(ot.extend(l, { elem: t, anim: h, queue: h.opts.queue })),
      h
        ...
        function (t, i) {
          ...
          for (a = t, l = [], h = x.preFilter; a; ) {
            (n && !(r = lt.exec(a))) ||
              ...
              (r = ht.exec(a)) &&
                ((n = r.shift()),
                o.push({ value: n, type: r[0].replace(at, " ") }),
                (a = a.slice(n.length)));
            for (s in x.filter)
              !(r = dt[s].exec(a)) ||
                (h[s] && !(r = h[s](r))) ||
  ...
  ot.extend({
    ...
    (ot.cssHooks.marginRight = A(nt.reliableMarginRight, function (t, e) {
      return e
        ? Kt(t, { display: "inline-block" }, S, [t, "marginRight"])
        : void 0;
    })),
    ...
    var t = document.documentElement,
      ...
      o = function (i, o) {
        var s = n(i).getBoundingClientRect(),
          ...
          h = { x: s.left - l.left, y: s.top - l.top };
    ...
    var C = null,
      ...
      I = function () {
        ...
        t ||
          ...
          u(t.style, { top: 0, left: 0, position: "absolute" }),
            ...
            b = (function () {
              ...
              return (
                ...
                (h.prototype._triggerSlideEvent = function (e, i) {
                  var n = t.Event(v.SLIDE, { relatedTarget: e, direction: i });
                ...
                (h.prototype._slide = function (e, i) {
                  ...
                  if (!h.isDefaultPrevented() && r && s) {
                    ...
                    var u = t.Event(v.SLID, { relatedTarget: s, direction: l });
                    o.supportsTransitionEnd() &&
                ...
                (e.prototype.show = function () {
                  ...
                  if (
                    ...
                    r &&
                      ...
                      (n = n[n.length - 1]));
                    var a = t.Event(c.HIDE, { relatedTarget: this._element }),
                      l = t.Event(c.SHOW, { relatedTarget: n });
                    if (
                      (n && t(n).trigger(a),
            ...
            return (
              ...
              0 === r && I()
                ? ((n = e
                    ...
                    .replace(/[^0-9.]+/g, "")),
                  (i = { right: -14, paddingRight: +n + 14 }))
                : r &&
                  ((i = { right: -r }), this.$el.addClass("has-scrollbar")),
            ...
            return this.iOSNativeScrolling
              ...
              : (this.$el.find("." + this.options.paneClass).length ||
                ...
                ("static" === i || "relative" === i) &&
                  ...
                  f && this.$content.css({ right: "", marginRight: f })),
                this);
          }),
  ...
  (function () {
    ...
    function c() {
      ...
      function i(t) {
        t.length &&
          (t.removeClass("open"),
          T.to(t.children(".dropdown"), 0.3, { opacity: 0, display: "none" }),
          w.trigger("nk-closed-submenu", [t]));
      }
      function n(t) {
        t.hasClass("open") ||
          (e(t),
          T.to(t.children(".dropdown"), 0.3, { opacity: 1, display: "block" }),
          t.addClass("open"),
        ...
        (t.openFullscreenNavbar = function () {
          if (!n && e.length) {
            ...
            r.length || (r = e.find(".nk-nav > li > a")),
              ...
              T.set(r, { opacity: 0, force3D: !0 }),
              T.set(i, { opacity: 0, force3D: !0 }),
              T.to(e, 0.5, {
                opacity: 1,
                force3D: !0,
                display: "block",
              ...
              T.staggerTo(r, 0.3, { y: 0, opacity: 1, delay: 0.2 }, 0.05),
              T.to(i, 0.3, { y: 0, opacity: 1, delay: 0.4 }),
              e.addClass("open"),
              t.bodyOverflow(1),
      ...
      function t(t) {
        ...
        if (r.length) {
          ...
          l.hasClass("nk-nav-row-center") &&
            ...
            n.css("height", u),
            i.initPluginNano(e),
            T.to(a, 0.3, { scrollTo: { y: 0 }, delay: 0.2 });
        } else n.css("height", "");
        i.initPluginNano(e);
      }
      function e(t, e) {
        ...
        T.set(i, { x: t ? "15%" : "-15%", opacity: 0, display: "block" }, 0.1),
          T.staggerTo(i, 0.2, { x: "0%", opacity: 1, delay: 0.1 }, 0.03),
          T.staggerTo(
            n,
            0.2,
            { x: t ? "-15%" : "15%", opacity: 0 },
    ...
    function g() {
      if ("undefined" != typeof b.fn.jarallax) {
        b(".bg-image-parallax").jarallax({ speed: 0.8 });
      }
    }
    function v() {
      function t(t) {
          ...
          C.on("click", '[href="#nk-toggle-filter"]:not(.busy)', function (t) {
            ...
            if (e.length && n.length)
              if (
                ...
                var o = n.height();
                n.css("height", 0),
                  T.set(n.children(), { y: -10, opacity: 0 }),
                  T.to(n, 0.4, {
                    height: o,
                    marginBottom: 30,
                    marginTop: -23,
